...
const api: WooiApi = {
  ...
  repo: {
    ...
    listPrs: (repoId) => ipcRenderer.invoke(IPC.repoListPrs, repoId),
    resolvePr: (repoId, reference) => ipcRenderer.invoke(IPC.repoResolvePr, repoId, reference),
    getIssueBody: (repoId, number) => ipcRenderer.invoke(IPC.repoGetIssueBody, repoId, number),
    getPrBody: (repoId, number) => ipcRenderer.invoke(IPC.repoGetPrBody, repoId, number)
  },

  workspace: {
    create: (args) => ipcRenderer.invoke(IPC.workspaceCreate, args),
    fork: (workspaceId, opts) => ipcRenderer.invoke(IPC.workspaceFork, workspaceId, opts),
  ...
  chat: {
    ...
    clear: (workspaceId, opts) => ipcRenderer.invoke(IPC.chatClear, workspaceId, opts),
  ...
  stack: {
    ...
    trainCancel: (workspaceId) => ipcRenderer.invoke(IPC.stackTrainCancel, workspaceId),
    progress: () => ipcRenderer.invoke(IPC.stackProgressGet),
    progressDismiss: (workspaceId) => ipcRenderer.invoke(IPC.stackProgressDismiss, workspaceId),
    ...
    resolveConflict: (workspaceId) => ipcRenderer.invoke(IPC.stackResolveConflict, workspaceId)
  },
